...
if (is_admin()){
   ...
   */
  $config = array(
    'id' => 'cat_details',          // meta box id, unique per meta box
    'title' => 'Category Details',          // meta box title
    'pages' => array('category','programs','genre','group','sponsor_types'),        // taxonomy name, accept categories, post_tag and custom taxonomies
  ...
  //show child categories within page-------------
    //select field
  	$my_meta->addSelect($prefix.'children_display',
  	array('none'=>'None',
  	'accordian'=>'Accordian',
  	'aside'=>'Aside',
  	'carousel'=>'Carousel',
  	...
  	array('name'=> __('Show child categories as: ','tax-meta'),
  	'std'=> array('none')));
    
  //excerpt---------------------------------------
	//wysiwyg
    $my_meta->addWysiwyg($prefix.'excerpt',array('name'=> __('Excerpt ','tax-meta')));
